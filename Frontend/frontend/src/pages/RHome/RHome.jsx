...
const RHome = () => {
  return (
    ...
    <div style={{display:'flex'}}>
        <div className='h-1'>
            <h1 className='h1-1'>Hire Energetic..?</h1>
            <h1 className='h1-2'>Talented Candidates</h1>
            <p className='p-1'>Great platform for the recruiter that searching for</p>
            <p className='p-2'>hiring new and young talents for company</p>
        </div>
        <div>
